...
description: Discord vừa ra mắt tính năng Profile Widget, nhưng bạn không thể tùy chỉnh nó theo ý muốn mà phải phụ thuộc vào các ứng dụng và trò chơi được liên kết. Trong bài viết này, mình sẽ chia sẻ cách tạo một Profile Widget custom bằng cách tận dụng một số thủ thuật thú vị mà Discord hiện vẫn hỗ trợ.
pubDate: 2026-06-01
cover: /posts/cover-1.png
---

Discord vừa ra mắt tính năng Profile Widget, nhưng bạn không thể tùy chỉnh nó theo ý muốn mà phải phụ thuộc vào các ứng dụng và trò chơi được liên kết. Trong bài viết này, mình sẽ chia sẻ cách tạo một Profile Widget custom bằng cách tận dụng một số thủ thuật thú vị mà Discord hiện vẫn hỗ trợ.

**Lưu ý:** Cách mình hướng dẫn không hẳn là cách tốt nhất mà đơn giản chỉ là cách để tạo khái quát.
...
![Widget Editor](/posts/post-1_2.png)
...
Ngược lại, nếu bạn có nhu cầu tùy chỉnh widget sao cho phù hợp với nhiều người dùng (giống widget của game), hãy sử dụng type **User Data** và trường **Data Field**. Khi bạn sử dụng type này, bạn có thể thoải mái điều chỉnh thông tin sao cho phù hợp với từng người dùng bằng API với body JSON (*cái này chỉ dành cho các dev, người dùng cơ bản bỏ qua phần bên dưới nhé 👏*).

![Sample Data](/posts/post-1_3.png)
...
![Full Widget](/posts/post-1_4.png)
...
![OAuth2 stuff](/posts/post-1_6.png)
...
![Authorize application](/posts/post-1_7.png)
...
![Widget apply successfully](/posts/post-1_9.png)
...
Có thể sau này Discord sẽ fix, vì vậy hãy thực hiện càng sớm càng tốt.
